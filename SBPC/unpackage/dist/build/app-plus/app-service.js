...
d_[x[55]]={}
d_[x[55]]["d573abf0"]=function(e,s,r,gg){
var z=gz$gwx_35()
var b=x[55]+':d573abf0'
r.wxVkey=b
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/check/checkEdit"],{"08e6":function(t,e,i){"use strict";var o=i("2427"),n=i.n(o);n.a},"23b8":function(t,e,i){"use strict";i.r(e);var o=i("d54a"),n=i.n(o);for(var l in o)"default"!==l&&function(t){i.d(e,t,function(){return o[t]})}(l);e["default"]=n.a},2427:function(t,e,i){},"5d63":function(t,e,i){"use strict";i.r(e);var o=i("9f1b"),n=i.n(o);for(var l in o)"default"!==l&&function(t){i.d(e,t,function(){return o[t]})}(l);e["default"]=n.a},"9f1b":function(t,e,i){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o=u(i("8959")),n=u(i("09d6")),l=u(i("d36e")),s=u(i("d869")),c=u(i("9fbc")),a=(u(i("40bc")),u(i("736d"))),r=(u(i("fa28")),u(i("bc96"))),d=i("2f62");function u(t){return t&&t.__esModule?t:{default:t}}var f={computed:(0,d.mapState)(["userInfo"]),components:{uniList:o.default,uniListItem:l.default,uniIcon:n.default,prompt:s.default},data:function(){return{model:{recordid:"",userid:"",jcdzt:"1",jclx:"",llrid:"",llrmc:"",jcrq:"",qtcyid:"",qtcy:"",mb:"",jcjlList:[]},pageState:0,currentModule:null,checkTypes:[],selectedPersons:[],selectedModule:[],editable:!0,promptVisible:!1,normal:{color:"#24BE41",size:"22",type:"checkbox-filled"},undetected:{color:"#FFDE52",size:"22",type:"info-filled"},abnormal:{color:"#C11E1E",size:"22",type:"clear"},zplists:[]}},onLoad:function(t){this.model.userid=this.userInfo.userid,0==this.pageState&&(this.getCheckTypes(),this.getCheckModule(),this.model.llrid=this.userInfo.userid,this.model.llrmc=this.userInfo.username)},onNavigationBarButtonTap:function(){},onUnload:function(){},methods:{getCheckTypes:function(e){var i=this,o={userid:i.userInfo.userid};a.default.requestLoading(c.default.getCheckTypes,o,"正在获取检查类型",function(t){i.checkTypes=t.data},function(){t.showToast({icon:"none",title:"获取失败"})},function(){})},getCheckModule:function(e){var i=this,o={userid:i.userInfo.userid};a.default.requestLoading(c.default.getCheckModule,o,"正在获取检查模板",function(t){i.selectedModule=t.data},function(){t.showToast({icon:"none",title:"获取失败"})},function(){})},saveClick:function(e){var i=this;i.zplists=[],i.model.userid=i.userInfo.userid;for(var o=i.model,n=0;n<i.model.jcjlList.length;n++){var l=i.model.jcjlList[n];i.zplists.push(l.zplist)}a.default.requestLoading(c.default.saveCheck,o,"正在保存检查",function(e){i.model=e;for(var o=0;o<i.model.jcjlList.length;o++){var n=i.model.jcjlList[o];n.zplist=i.zplists[o]}i.uploadPhoto(!1,function(){t.showToast({icon:"none",title:"保存成功"})})},function(){t.showToast({icon:"none",title:"保存失败"})},function(){})},completeClick:function(t){},uploadPhoto:function(){arguments.length>0&&void 0!==arguments[0]&&arguments[0];for(var e=arguments.length>1?arguments[1]:void 0,i=this,o=0;o<i.model.jcjlList.length;o++){var n=i.model.jcjlList[o];console.log("item:"+JSON.stringify(n));var l=n.jcjlrecordid,s=n.zplist;r.default.uploadPhoto(i.userInfo.userid,l,"",s,function(o){o.length>0&&(t.showToast({icon:"none",title:"照片上传成功"}),i.classifyPhotos(o)),e()})}},classifyPhotos:function(t){if(null!=t){for(var e=0;e<this.model.jcjlList.length;e++)this.model.jcjlList[e].zplist=[];for(e=0;e<t.length;e++)for(var i=t[e],o={fileid:i.attid,src:c.default.host+c.default.loadImage+"&attid="+i.attid,type:2,yhid:i.zpsgrecordid,attachtype:i.attachtype},n=0;n<this.model.jcjlList.length;n++){var l=this.model.jcjlList[n];l.jcjlrecordid==i.zpsgrecordid&&this.model.jcjlList[n].zplist.push(o)}}},typePickerChange:function(t,e){this.model[e.target.id]=t[e.target.value].dictvalue,this.model["jclxbm"]=t[e.target.value].dictvalue},dateChange:function(t,e){this.model[t]=e.target.value},jumpPersonChoose:function(e){var i=this,o="CHECK_PERSONS";t.navigateTo({url:"../common/personChoose?key="+o+"&mltiple=true&selected="+JSON.stringify(this.selectedPersons)}),i.$fire.once(o,function(t){i.selectedPersons=t,i.formatPersons()})},mbChange:function(t,e){this.currentModule=t[e.target.value],this.model[e.target.id]=t[e.target.value].mbmc,this.getCheckInfoByMb()},getCheckInfoByMb:function(){var e=this,i={userid:e.userInfo.userid,mbid:e.currentModule.mbid};a.default.requestLoading(c.default.getCheckInfo,i,"正在获取检查项",function(t){e.model.jcjlList=t.data},function(){t.showToast({icon:"none",title:"获取失败"})},function(){})},jumpEdit:function(e,i){var o=this;if(0!=this.editable){var n="INFO_EDIT";t.navigateTo({url:"checkInfoEdit?item="+JSON.stringify(e)+"&index="+i+"&key="+n}),this.$fire.once(n,function(t){o.model.jcjlList.splice(t.index,1,t.item)})}},addCheck:function(t){this.promptVisible=!0},clickPromptConfirm:function(e){if(""!=e){var i={bzlx:"",idx:"",ifwt:"",jcbz:e,jcbzid:"",jcjlrecordid:"",precordid:"",wtms:"",xmhfl:"",xmhflid:"",zgqk:"",zgtzdid:"",zgtzdmoduleid:"",zgzt:"",zplist:[]};this.model.jcjlList.push(i),this.promptVisible=!1}else t.showToast({icon:"none",title:"请输入检查标题内容"})},clickCancel:function(t){this.promptVisible=!1},formatPersons:function(){for(var t="",e="",i=0;i<this.selectedPersons.length;i++){var o=this.selectedPersons[i];t=o.id+";"+t,e=o.name+";"+e}this.model.qtcy=e,this.model.qtcyid=t},getIcon:function(t){return"1"==t.ifwt?this.normal:"3"==t.ifwt?this.abnormal:this.undetected}}};e.default=f}).call(this,i("6e42")["default"])},ad76:function(t,e,i){"use strict";i("c6c1");var o=l(i("b0ce")),n=l(i("cd38"));function l(t){return t&&t.__esModule?t:{default:t}}Page((0,o.default)(n.default))},ae6f:function(t,e,i){"use strict";var o=function(){var t=this,e=t.$createElement,i=t._self._c||e;return t.visible?t._e():i("view",{staticClass:"prompt-box",attrs:{eventid:"15605040-3"},on:{touchmove:!0}},[i("view",{staticClass:"prompt"},[i("view",{staticClass:"prompt-top"},[i("text",{staticClass:"prompt-title"},[t._v(t._s(t.title))]),i("input",{directives:[{name:"model",rawName:"v-model",value:t.value,expression:"value"}],staticClass:"prompt-input",attrs:{type:"text",placeholder:t.placeholder,eventid:"15605040-0"},domProps:{value:t.value},on:{input:function(e){e.target.composing||(t.value=e.target.value)}}})]),t._t("default",null,{mpcomid:"15605040-0"}),i("view",{staticClass:"prompt-buttons",style:"background:"+t.mainColor},[i("button",{staticClass:"prompt-cancle",style:"color:"+t.cancelColor,attrs:{eventid:"15605040-1"},on:{click:function(e){t.$emit("cancel",t.value)}}},[t._v("取消")]),i("button",{style:"color:"+t.mainColor,attrs:{eventid:"15605040-2"},on:{click:function(e){t.$emit("confirm",t.value)}}},[t._v("确定")])],1)],2)])},n=[];i.d(e,"a",function(){return o}),i.d(e,"b",function(){return n})},c5fc:function(t,e,i){},cd38:function(t,e,i){"use strict";i.r(e);var o=i("d985"),n=i("5d63");for(var l in n)"default"!==l&&function(t){i.d(e,t,function(){return n[t]})}(l);i("d490");var s=i("2877"),c=Object(s["a"])(n["default"],o["a"],o["b"],!1,null,null,null);e["default"]=c.exports},d490:function(t,e,i){"use strict";var o=i("c5fc"),n=i.n(o);n.a},d54a:function(t,e,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o={props:{visible:{type:Boolean,default:!1,required:!0},title:{type:String,default:"提示"},placeholder:{type:String,default:"请输入内容"},cancelColor:{type:String,default:"#818181"},mainColor:{type:String,default:"#3296FA"},defaultValue:{type:String}},data:function(){return{value:""}},mounted:function(){this.value=this.defaultValue},methods:{close:function(){this.$emit("update:visible",!1)}}};e.default=o},d869:function(t,e,i){"use strict";i.r(e);var o=i("ae6f"),n=i("23b8");for(var l in n)"default"!==l&&function(t){i.d(e,t,function(){return n[t]})}(l);i("08e6");var s=i("2877"),c=Object(s["a"])(n["default"],o["a"],o["b"],!1,null,"0850b3d4",null);e["default"]=c.exports},d985:function(t,e,i){"use strict";var o=function(){var t=this,e=t.$createElement,i=t._self._c||e;return i("view",{staticClass:"baseView"},[i("scroll-view",{staticClass:"scrollView",attrs:{"scroll-y":"true"}},[i("view",{staticClass:"cellTitleView"},[i("text",{staticClass:"cellTitle"},[t._v("基础信息")])]),i("view",{staticClass:"cellInfoView"},[i("uni-list",{attrs:{mpcomid:"609973d6-5"}},[i("picker",{attrs:{id:"jclx",range:t.checkTypes,"range-key":"dictvalue",eventid:"609973d6-0"},on:{change:function(e){t.typePickerChange(t.checkTypes,e)}}},[i("uni-list-item",{attrs:{title:"检查类型",subnote:t.model.jclx,"show-arrow":!0,mpcomid:"609973d6-0"}})],1),i("uni-list-item",{attrs:{title:"检查人",subnote:t.model.llrmc,"show-arrow":"false",mpcomid:"609973d6-1"}}),i("picker",{attrs:{mode:"date",value:t.model.jcrq,eventid:"609973d6-1"},on:{change:function(e){t.dateChange("jcrq",e)}}},[i("uni-list-item",{attrs:{title:"检查日期",subnote:t.model.jcrq,"show-arrow":!0,mpcomid:"609973d6-2"}})],1),i("uni-list-item",{attrs:{title:"检查组成员",subnote:t.model.qtcy,"show-arrow":!0,eventid:"609973d6-2",mpcomid:"609973d6-3"},on:{click:t.jumpPersonChoose}}),i("picker",{attrs:{id:"mb",range:t.selectedModule,"range-key":"mbmc",eventid:"609973d6-3"},on:{change:function(e){t.mbChange(t.selectedModule,e)}}},[i("uni-list-item",{attrs:{title:"检查模板",subnote:t.model.mb,"show-arrow":!0,mpcomid:"609973d6-4"}})],1)],1)],1),t.model.jcjlList.length>0?i("block",[i("view",{staticClass:"cellTitleView"},[i("text",{staticClass:"cellTitle"},[t._v("检查内容")]),i("text",{staticClass:"cellTitle"},[t._v("正常-")]),i("uni-icon",{attrs:{type:"checkbox-filled",size:"22",color:"#24BE41",mpcomid:"609973d6-6"}}),i("text",{staticClass:"cellTitle"},[t._v("未检-")]),i("uni-icon",{attrs:{type:"info-filled",size:"22",color:"#FFDE52",mpcomid:"609973d6-7"}}),i("text",{staticClass:"cellTitle"},[t._v("异常-")]),i("uni-icon",{attrs:{type:"clear",size:"22",color:"#C11E1E",mpcomid:"609973d6-8"}})],1),i("view",{staticClass:"cellInfoView"},[i("uni-list",{attrs:{mpcomid:"609973d6-10"}},t._l(t.model.jcjlList,function(e,o){return i("uni-list-item",{key:o,attrs:{title:e.jcbz,note:e.wtms,"show-extra-icon":"true","show-arrow":t.editable,"extra-icon":t.getIcon(e),eventid:"609973d6-4-"+o,mpcomid:"609973d6-9-"+o},on:{click:function(i){t.jumpEdit(e,o)}}})}))],1),i("image",{staticClass:"addCheck",attrs:{mode:"aspectFit",src:"../../static/assets/addCheck.png",eventid:"609973d6-5"},on:{click:t.addCheck}})]):t._e()],1),i("view",{staticClass:"bottomView"},[i("view",{staticClass:"buttonStyle",attrs:{eventid:"609973d6-6"},on:{click:t.saveClick}},[t._v("保存")]),i("view",{staticClass:"buttonStyle",attrs:{eventid:"609973d6-7"},on:{click:t.completeClick}},[t._v("完成检查")])]),t.promptVisible?i("prompt",{attrs:{title:"添加检查内容",placeholder:"请输入检查标题",defaultValue:"",mainColor:"#3296FA",eventid:"609973d6-8",mpcomid:"609973d6-11"},on:{cancel:t.clickCancel,confirm:t.clickPromptConfirm}}):t._e()],1)},n=[];i.d(e,"a",function(){return o}),i.d(e,"b",function(){return n})}},[["ad76","common/runtime","common/vendor"]]]);
});
