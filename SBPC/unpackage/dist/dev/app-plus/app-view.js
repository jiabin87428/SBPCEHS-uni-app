...
var bO=_mz(z,'image',['class',18,'mode',1,'src',2],[],hG,cF,gg)
cs.pop()
_(tM,bO)
cs.push("./pages/common/orgChoose.vue.wxml:view:1:620")
var oP=_n('view')
...
cs.pop()
_(oH,oJ)
cs.push("./pages/common/orgChoose.vue.wxml:view:1:686")
var oR=_n('view')
